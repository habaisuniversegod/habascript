...
#define HS_ERR_UNKNOWNCHARACTERWHILELX(l,m,ch) hs_front_err(-3, l, m, HS_ERR_MAJ_LEXER, HS_ERR_MIN_SYNTAXERR, snprintf(hs_err_buffer, HS_ERRORMSG_BUF_SIZE, "Unrecognized operator '%c'", ch))